...
| 7 | Tier 2 on 20 seeds; per-seed comparison with tier 1; decide who carries the 5 000 | **done 2026-08-25** — 23 seeds, 1.3–35.5 m/s: the closed loop matches the tier-1 zero-start surrogate (median onset difference +0.30 s, median \|diff\| 0.55 s, 19/23 seeds) and rejects the stationary start; tier 1 carries the 5 000 (results doc §5) |
