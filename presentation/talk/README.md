...
| `build_concepts_talk.py` | builds the concepts deck; `make_concept_animations.py` builds its seven GIFs from tracked outputs (`out/stage1_looming.md`, `out/cutin2_gate.md`, `out/cutin2_cells.csv`, the study-2 traces) |
